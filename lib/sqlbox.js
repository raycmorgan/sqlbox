...
function create(opts) {
  ...
  assert(model.name, 'sqlbox.create must be supplied a name ' +
...
/**
 * Registers the model, in its namespace into sqlbox.
 *
 * @param model Object The model object to register
 */
function registerModel(model) {
  var namespace = model.namespace ? model.namespace : 'GLOBAL';

  models[namespace] = models[namespace] || {};
  models[namespace][model.name] = model;
}
